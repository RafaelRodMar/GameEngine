    ...
    while(window.pollEvent(event))
    {
        ...
        if (event.type == sf::Event::MouseButtonPressed)
        {
            if(event.mouseButton.button == sf::Mouse::Left)
                MouseButtonDown(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y, true);
        }
        ...
        {
            if(event.mouseButton.button == sf::Mouse::Left)
                MouseButtonUp(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y, true);
        }
        ...
        if (event.type == sf::Event::MouseButtonPressed)
        {
            if(event.mouseButton.button == sf::Mouse::Right)
                MouseButtonDown(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y, false);
        }
        ...
        {
            if(event.mouseButton.button == sf::Mouse::Right)
                MouseButtonUp(sf::Mouse::getPosition(window).x, sf::Mouse::getPosition(window).y, false);
        }
