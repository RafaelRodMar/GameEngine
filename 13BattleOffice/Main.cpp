...
bool GameInitialize()
{
    pGame = new GameEngine("Battle Office",500,400);
...
{
    //load assets
    pGame->loadSoundBuffer("boo", "assets/snd/boo.wav");
    pGame->loadSoundBuffer("taunt", "assets/snd/taunt.wav");
    pGame->loadSoundBuffer("whack", "assets/snd/whack.wav");
    pGame->openMusic("music", "assets/mus/music.ogg");
    pGame->loadTexture("gameover", "assets/img/gameover.png");
    pGame->loadTexture("guy1", "assets/img/guy1.png");
    pGame->loadTexture("guy2", "assets/img/guy2.png");
    pGame->loadTexture("guy3", "assets/img/guy3.png");
    pGame->loadTexture("guy4", "assets/img/guy4.png");
    pGame->loadTexture("office", "assets/img/office.png");
    pGame->loadTexture("guy5", "assets/img/guy5.png");
    pGame->loadTexture("pow", "assets/img/pow.png");
    pGame->loadTexture("smallguy", "assets/img/smallguy.png");
    pGame->loadTexture("target", "assets/img/target.png");
